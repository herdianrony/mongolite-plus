...
$jumlahMigrasi = $client->migrateData(
    ...
    'data_pengguna',
    'pelanggan',
    // PERBAIKAN: Mengubah filter dari array menjadi callable (fungsi)
    function ($dokumen) {
...
// Menggunakan Database Terenkripsi
$dbRahasia = $client->getDatabase('dokumen_rahasia', 'PasswordSangatKuat');
$dbRahasia->catatan->insert(['judul' => 'Rencana Rahasia', 'konten' => '...']);
echo "Data berhasil dimasukkan ke database terenkripsi.\n";

// Mengganti kunci enkripsi
$dbRahasia->changeEncryptionKey('PasswordBaruYangLebihKuat');
echo "Kunci enkripsi berhasil diganti.\n\n";
